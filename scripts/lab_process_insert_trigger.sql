DROP TRIGGER IF EXISTS `lab_process_insert_trigger`;

DELIMITER $$
-- ----------------------------------------------------------------------
-- This trigger monitors inserts into the redcap_data table to update
-- redcap_ddp_specimen table
-- ----------------------------------------------------------------------
create trigger lab_process_insert_trigger
after insert
